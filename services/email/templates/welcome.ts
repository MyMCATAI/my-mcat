    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <ul>
          ...
          <li>Join our <a href="https://discord.gg/PkRbV5nw" style="color: #3B82F6; text-decoration: underline;">Discord community</a> to study with friends, tutoring sessions, webinars, and early insight into new features</li>
        </ul>
