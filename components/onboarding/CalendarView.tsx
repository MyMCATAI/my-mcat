  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div 
        ...
        className="bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-xl"
      >
              ...
              toolbar: ({ label, onNavigate }) => (
                <div className="flex items-center justify-between mb-6">
                  <button 
                    ...
                    className="p-3 hover:bg-gradient-to-r hover:from-blue-100 hover:to-purple-100 dark:hover:from-gray-700 dark:hover:to-gray-600 rounded-xl transition-all duration-200 shadow-md"
                  >
                    <ChevronLeft className="w-5 h-5 text-gray-700 dark:text-gray-300" />
                  </button>
                  <span className="text-xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">{label}</span>
                  <button 
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
          <div className="flex items-center gap-3 bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/30 px-4 py-2 rounded-xl">
            <div className="w-4 h-4 bg-gradient-to-r from-red-400 to-red-600 rounded-lg shadow-sm"></div>
            <span className="text-gray-700 dark:text-gray-300 font-semibold">Exams</span>
          </div>
          <div className="flex items-center gap-3 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 px-4 py-2 rounded-xl">
            <div className="w-4 h-4 bg-gradient-to-r from-purple-400 to-purple-600 rounded-lg shadow-sm"></div>
            <span className="text-gray-700 dark:text-gray-300 font-semibold">Tutoring</span>
          </div>
          <div className="flex items-center gap-3 bg-gradient-to-r from-cyan-50 to-cyan-100 dark:from-cyan-900/30 dark:to-cyan-800/30 px-4 py-2 rounded-xl">
            <div className="w-4 h-4 bg-gradient-to-r from-cyan-400 to-cyan-600 rounded-lg shadow-sm"></div>
            <span className="text-gray-700 dark:text-gray-300 font-semibold">Group Classes</span>
          </div>
          <div className="flex items-center gap-3 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 px-4 py-2 rounded-xl">
            <div className="w-4 h-4 bg-gradient-to-r from-green-400 to-green-600 rounded-lg shadow-sm"></div>
            <span className="text-gray-700 dark:text-gray-300 font-semibold">FREE Sessions</span>
          </div>
          <div className="flex items-center gap-3 bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/30 dark:to-amber-800/30 px-4 py-2 rounded-xl">
            <div className="w-4 h-4 bg-gradient-to-r from-amber-400 to-amber-600 rounded-lg shadow-sm"></div>
            <span className="text-gray-700 dark:text-gray-300 font-semibold">Content Review</span>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-white via-gray-50/50 to-blue-50/50 dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-xl"
      >
        {/* Pricing Header */}
        <div className="text-center mb-8">
          ...
          >
            ...
            <h3 className="text-3xl font-bold bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
              Pricing
            </h3>
          </motion.div>
          ...
          {PRICING_TIERS.map((tier, index) => {
            ...
            return (
              <motion.div
                ...
                className={`relative bg-gradient-to-br ${tier.bgColor} rounded-2xl p-6 border border-gray-200/50 dark:border-gray-600/50 cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105 group`}
              ...
              >
                ...
                <div className="flex justify-center mb-4">
                  <div className={`p-4 rounded-2xl bg-gradient-to-r ${tier.color} text-white shadow-lg group-hover:shadow-xl transition-all duration-300`}>
                ...
                {selectedPricing === tier.id && (
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center shadow-lg"
                  >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 2 }}
          className="mt-8 text-center bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-800/30 rounded-xl p-6"
        >
