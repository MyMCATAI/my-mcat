...
import logo from "../../public/studyversemedicine.png";
  ...
  const linkSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "https://app.termly.io/policy-viewer/policy.html?policyUUID=be6601a9-d045-4aee-b088-07144de2d7a0", text: "Cookie Policy" },
