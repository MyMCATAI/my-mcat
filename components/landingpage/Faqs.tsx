...
const Faqs = () => {
    ...
    const items = [
        ...
        { heading: "If werewolves exist, do whenwolves exist?", text: `Wild thought. <a href="https://discord.gg/c8VjPeKc" class="text-blue-600 hover:text-blue-800" target="_blank" rel="noopener noreferrer">Join our discord</a> and ask our community! Surely, someone will know the answer.`, icon: icon },
