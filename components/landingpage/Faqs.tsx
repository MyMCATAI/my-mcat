...
const Faqs = () => {
    ...
    const items = [
        ...
        { heading: "Who are your founders?", text: `Prynce is a 523 scorer and our product architect, front end engineer, AI wizard, and CEO. Josh is CTO, a computer science and tech genius who makes the dream into reality. Both of them work together with the hopes of changing medical education for the better`, icon: icon },
        { heading: "If werewolves exist, might there theoretically exist whenwolves?", text: `Wild thought. Join our<a href="https://discord.gg/mXVkbzFq" target="_blank" rel="noopener noreferrer"> discord</a> and ask our community! Surely, someone will know the answer.`, icon: icon },
