...
const Faqs = () => {
    ...
    const items = [
        { heading: "Why did you start this company?", text: 'Test prep companies have a habit of overpromising and underdelivering. We want to change that.', icon: icon },
        ...
        { heading: "If werewolves exist, do whenwolves exist?", text: `Wild thought. <a href="https://discord.gg/DcHWnEu8Xb" class="text-blue-600 hover:text-blue-800" target="_blank" rel="noopener noreferrer">Join our discord</a> and ask our community! Surely, someone will know the answer.`, icon: icon },
        ...
        { heading: "How do you compare to other test prep companies?", text: `MyMCAT is a premium product focused on delivering quality. We are free only because we believe in the power of community.`, icon: icon },
    ];
