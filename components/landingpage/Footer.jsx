        ...
        <footer className="bg-[#2D4778] ">
            <div className="mx-auto max-w-screen-xl p-4 py-6 ">
                <div className="flex justify-between" style={{padding:"16px 0"}}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-6">
                        <div className="text-center md:text-left">
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase text-white">Links</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a href="#" className="hover:underline text-white">Link 1</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:underline text-white">Link 2</a>
                                </li>
                            </ul>
                        </div>
                        <div className="text-center md:text-left">
                ...
                <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-500 sm:text-center text-gray-400">© 2024 <a href="#" className="hover:underline text-gray-400">KarkiSuit</a>. All Rights Reserved.</span>
