...
const MissionStep = ({ onNext }: MissionStepProps) => {
  /* ---- Render Methods ----- */
  return (
    <div className="text-center space-y-12">
      ...
      <div className="max-w-3xl mx-auto p-8 rounded-2xl bg-gradient-to-br from-black/60 to-black/40 
        ...
        <p className="relative text-white/90 text-xl leading-relaxed font-light">
          {`Join our community on Discord to discover other students to study with, find tutors, and keep up with MyMCAT.ai.`}  
        </p>
      </div>
