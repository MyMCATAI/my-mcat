  ...
  return (
    <>
      <section className="relative h-screen overflow-hidden bg-[#050010]" id="home">
        ...
        <div className="relative z-10 container mx-auto px-3 h-full flex items-center">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
            <div className="text-center">
              <h1 className="text-2xl ml-4 md:text-[44px] font-bold text-white mb-4">
              <span className="text-[#f2f64f]">Increase </span> your CARs score.
              </h1>
              <p className="text-lg md:text-[18px] text-white my-8">
                Make strategy easy with your learning companion Kalypso.
              </p>
              <div className="flex justify-center">
                <Link href="/intro">
                  <button className="bg-[#ffffff] mt-3 text-[#0e2247] py-4 text-lg md:text-[20px] px-7 rounded-[20px] transition-colors duration-300 hover:bg-blue-500 hover:text-white">
      ...
      >
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="w-full md:w-[80%] mx-auto mb-40 text-center space-y-12">
            <h2 ref={titleRef} className="text-4xl text-center text-white font-bold mb-16 pt-12">Meow there!</h2>
            <p ref={paragraph1Ref} className="text-2xl text-center text-white mb-12">
              No more outdated prep because we focus on <strong className="font-bold">technological innovation.</strong>
            </p>
            <p ref={paragraph2Ref} className="text-2xl text-center text-white mb-12">
              No more old <strong className="font-bold">just like you.</strong>
            </p>
            <p ref={paragraph3Ref} className="text-2xl text-center text-white mb-12">
              Who care about <strong className="font-bold">a fair shot.</strong>
            </p>
