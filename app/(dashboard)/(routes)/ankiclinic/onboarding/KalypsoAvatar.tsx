...
const KalypsoAvatar: React.FC<KalypsoAvatarProps> = ({ onAction }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-[-2rem] right-[-12rem] md:bottom-[-6rem] md:right-[-8rem] z-[10002] overflow-hidden"
    >
      <div className="w-[32rem] h-[32rem] md:w-[50rem] md:h-[50rem] relative">
