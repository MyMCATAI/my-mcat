...
import { ChevronLeft, ChevronRight, HelpCircle, Star, StarHalf } from 'lucide-react';
...
// Add this interface to define tutor expertise
                ...
                <div className="mt-4 flex justify-end">
                  <Dialog>
                    <DialogTrigger asChild>
                      ...
                      >
                        Book {firstName} {tutor.name === "Prynce K." ? `(50 coins/hr)` : `($${tutor.price}/hr)`}
                      </button>
                    </DialogTrigger>
