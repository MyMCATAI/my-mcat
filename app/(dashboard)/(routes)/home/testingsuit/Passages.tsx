    ...
    <div className="h-full flex flex-col p-4 text-white">
      <div className="flex-grow grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="md:col-span-2">
          <div className="h-full bg-[#021226] p-2 border-4 border-[#007AFF] rounded-[30px]"
               style={{
                 boxShadow: "rgba(61, 165, 233, 0.25) 0px 14px 28px, rgba(61, 165, 233, 0.22) 0px 10px 10px",
               }}>
        ...
        <div className="md:col-span-3 overflow-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {tests.map((test) => (
              ...
              >
                <div
                  className="bg-[#021226] border-4 text-center border-[#007AFF] text-md text-white rounded-[30px] px-4 py-2 h-full flex flex-col justify-between"
                  style={{
                    boxShadow:
