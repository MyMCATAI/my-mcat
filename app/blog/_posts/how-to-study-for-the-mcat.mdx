...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
  ...
  >
    <h3 className="text-xl text-black font-bold mb-2">Weakness Finding Algorithm</h3>
    <p className="text-xs text-gray-500">Learn how MyMCAT uses Thompson sampling to identify and target your weak areas</p>
  </a>

  <a 
    href="/blog/mcat-study-misconceptions" 
    className="block p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow"
  >
    <h3 className="text-xl text-black font-bold mb-2">Common MCAT Study Misconceptions</h3>
    <p className="text-xs text-gray-500">Avoid common pitfalls and optimize your MCAT preparation strategy</p>
  </a>
</div>
