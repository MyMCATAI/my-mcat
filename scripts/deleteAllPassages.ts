...
async function deleteAllPassages() {
  try {
    ...
    console.log(`Deleted ${deleteQuestionsResult.count} questions associated with passages.`);
    ...
    console.log("All passages and their associated questions have been deleted.");
  } catch (error) {
